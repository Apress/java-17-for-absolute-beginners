...
import com.apress.bgn.four.hierarchy.Actor;
import com.apress.bgn.four.hierarchy.Human;
import com.apress.bgn.four.hierarchy.Musician;
import com.apress.bgn.four.hierarchy.Performer;

/**
 * Created by iuliana.cosmina on 14/04/2021
 */
public class ReferencesDemo {
    ...
    private static void oneObjectMultipleReferences() {
    ...
    private static void multipleObjectAndReferences() {
        Performer performer = new Performer("John", 40, 1.91f, Gender.MALE);
